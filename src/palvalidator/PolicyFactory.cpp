...
namespace statistics
{
  ...
  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::AllHighResLogPFPolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::AllHighResLogPFPolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::RobustProfitFactorPolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::RobustProfitFactorPolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::NonGranularProfitFactorPolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::NonGranularProfitFactorPolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::CumulativeReturnPolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::CumulativeReturnPolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::NormalizedReturnPolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::NormalizedReturnPolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::PessimisticReturnRatioPolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::PessimisticReturnRatioPolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::PalProfitabilityPolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::PalProfitabilityPolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::GatedPerformanceScaledPalPolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::GatedPerformanceScaledPalPolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::ConfidenceAdjustedPalPolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::ConfidenceAdjustedPalPolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::EnhancedBarScorePolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::EnhancedBarScorePolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::HybridEnhancedTradeAwarePolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::HybridEnhancedTradeAwarePolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::AccumulationSwingIndexPolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::AccumulationSwingIndexPolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::HybridSwingTradePolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::HybridSwingTradePolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::ProfitFactorGatedSwingPolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::ProfitFactorGatedSwingPolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::BootStrappedProfitFactorPolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::BootStrappedProfitFactorPolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::BootStrappedLogProfitFactorPolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::BootStrappedLogProfitFactorPolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::BootStrappedProfitabilityPFPolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::BootStrappedProfitabilityPFPolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::BootStrappedLogProfitabilityPFPolicy>(unsigned long permutations, bool sameDayExits)
  {
    return std::make_unique<UnadjustedValidationWrapper<mkc_timeseries::BootStrappedLogProfitabilityPFPolicy>>(permutations, sameDayExits);
  }

  template<>
  std::unique_ptr<ValidationInterface> PolicyFactory::createUnadjustedValidationWrapper<mkc_timeseries::BootStrappedSharpeRatioPolicy>(unsigned long permutations, bool sameDayExits)
  {
										 ...
										 bool sameDayExits)
  {
    ...
    return it->second(permutations, sameDayExits);
  }
} // namespace statistics
