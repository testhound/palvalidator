...
TEST_CASE ("Market Order Operations", "[TradingOrder]")
{
  ...
  SellAtStopOrder<7> longOrder1(symbol1, units, orderDate1, createDecimal("108.00"));   // hit on 1/6/2016
  SellAtStopOrder<7> longOrder2(symbol2, units, orderDate2, createDecimal("205.00"));   // hot on 8/21/2015
  SellAtStopOrder<7> longOrder3(symbol3, units2, orderDate3, createDecimal("126.76"));  // hit on 8/18/2015
  SellAtStopOrder<7> longOrder4(symbol4, units2, orderDate4, createDecimal("96.50"));   // hit on 1/29/2016

  CoverAtStopOrder<7> shortOrder1(symbol1, units, orderDate1,createDecimal("112.00")); // hit on 12/23/2015
  CoverAtStopOrder<7> shortOrder2(symbol2, units, orderDate2,createDecimal("210.25")); // hit on 8/18/2015
  CoverAtStopOrder<7> shortOrder3(symbol3, units2, orderDate3,createDecimal("119.90")); // hit on 8/12/2015
  CoverAtStopOrder<7> shortOrder4(symbol4, units2, orderDate4, createDecimal("93.00")); // hit on  1/28/2016
  ...
  SECTION ("Verify orders are executed")
  {
    ...
    DecimalType fillPrice(fromString<DecimalType>("108.00"));
  ...
  {
    date fillDate(from_undelimited_string ("20160106"));
    DecimalType fillPrice(fromString<DecimalType>("108.52"));
  ...
  SECTION ("Throw exception if short stop fill price is less than stop price")
  {
    ...
    DecimalType fillPrice(fromString<DecimalType>("111.14"));
  ...
  SECTION ("Throw exception if attempt to cancel executed order (long side)")
  {
    ...
    DecimalType fillPrice(fromString<DecimalType>("204.07"));
  ...
  SECTION ("Throw exception if attempt to execute canceled order (short side)")
  {
    ...
    DecimalType fillPrice(fromString<DecimalType>("210.25"));
