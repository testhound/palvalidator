...
//    auto open1 = std::make_shared<DecimalType> (dec::fromString<DecimalType>(openPrice));
//    auto high1 = std::make_shared<DecimalType> (dec::fromString<DecimalType>(highPrice));
//    auto low1 = std::make_shared<DecimalType> (dec::fromString<DecimalType>(lowPrice));
//    auto close1 = std::make_shared<DecimalType> (dec::fromString<DecimalType>(closePrice));
...
//  OpenLongPosition<DecimalType> open1(longEntryPrice1, *entry0, TradingVolume(12, TradingVolume::VolumeUnit::CONTRACTS));

//  ClosedLongPosition<DecimalType> longPosition1(std::make_shared<OpenLongPosition<DecimalType>>(open1),
...
//  ClosedLongPosition<DecimalType> longPosition2(longEntryDate2, longEntryPrice2,
//				      longExitDate2, longExitPrice2,
//				      oneContract, 18);
  
//  ClosedLongPosition<DecimalType> longPosition3(TimeSeriesDate(1986, Oct, 29),
//				      createDecimal("3087.43726"),
//				      TimeSeriesDate(1986, Oct, 30),
//				      createDecimal("3166.47565"),
//				      oneContract, 1);
//  ClosedLongPosition<DecimalType> longPosition4(TimeSeriesDate(1987, Apr, 22),
//				      createDecimal("2808.12280"),
//				      TimeSeriesDate(1987, Apr, 24),
//				      createDecimal("2880.01075"),
//				      oneContract, 2);
//  ClosedLongPosition<DecimalType> longPosition5(TimeSeriesDate(1987, Dec, 4),
//				      createDecimal("2663.11865"),
//				      TimeSeriesDate(1987, Dec, 16),
//				      createDecimal("2624.47192"),
//				      oneContract, 8);
//  ClosedLongPosition<DecimalType> longPosition6(TimeSeriesDate(1988, Apr, 6),
//				      createDecimal("2817.15112"),
//				      TimeSeriesDate(1988, Apr, 14),
//				      createDecimal("2781.09159"),
//				      oneContract, 6);
//  ClosedLongPosition<DecimalType> longPosition7(TimeSeriesDate(1989, Apr, 14),
//				      createDecimal("3198.38672"),
//				      TimeSeriesDate(1989, Apr, 17),
//				      createDecimal("3280.26542"),
//				      oneContract, 1);
//  ClosedLongPosition<DecimalType> longPosition8(TimeSeriesDate(1990, Jun, 5),
//				      createDecimal("3207.87378"),
//				      TimeSeriesDate(1990, Jun, 8),
//				      createDecimal("3289.99535"),
//				      oneContract, 3);
//  ClosedLongPosition<DecimalType> longPosition9(TimeSeriesDate(1990, Dec, 7),
//				      createDecimal("2698.28857"),
//				      TimeSeriesDate(1990, Dec, 20),
//				      createDecimal("2663.75048"),
//				      oneContract, 9);
//  ClosedLongPosition<DecimalType> longPosition10(TimeSeriesDate(1991, Jul, 24),
//				      createDecimal("2631.70996"),
//				      TimeSeriesDate(1991, Jul, 29),
//				      createDecimal("2778.95728"),
//				      oneContract, 3);
//  ClosedLongPosition<DecimalType> longPosition11(TimeSeriesDate(1991, Aug, 5),
//				      createDecimal("2637.06445"),
//				      TimeSeriesDate(1991, Aug, 6),
//				      createDecimal("2704.57330"),
//				      oneContract, 1);
//  ClosedLongPosition<DecimalType> longPosition12(TimeSeriesDate(1993, Jun, 30),
//				      createDecimal("1917.15833"),
//				      TimeSeriesDate(1993, Jul, 1),
//				      createDecimal("1966.23758"),
//				       oneContract, 1);
//  ClosedLongPosition<DecimalType> longPosition13(TimeSeriesDate(1994, Jun, 22),
//				       createDecimal("1972.07410"),
//				       TimeSeriesDate(1994, Jun, 27),
//				       createDecimal("1946.83155"),
//				       oneContract, 3);
//  ClosedLongPosition<DecimalType> longPosition14(TimeSeriesDate(1995, Jun, 9),
//				       createDecimal("1880.15967"),
//				       TimeSeriesDate(1995, Jun, 15),
//				       createDecimal("1928.29176"),
//				       oneContract, 4);
//  ClosedLongPosition<DecimalType> longPosition15(TimeSeriesDate(1995, Aug, 23),
//				       createDecimal("1935.83447"),
//				       TimeSeriesDate(1995, Aug, 28),
//				       createDecimal("1985.39184"),
//				       oneContract, 3);
//  ClosedLongPosition<DecimalType> longPosition16(TimeSeriesDate(1995, Oct, 6),
//				       createDecimal("2116.94531"),
//				       TimeSeriesDate(1995, Oct, 10),
//				       createDecimal("2171.13911"),
//				       oneContract, 2);
//  ClosedLongPosition<DecimalType> longPosition17(TimeSeriesDate(1995, Nov, 9),
//				       createDecimal("2224.58643"),
//				       TimeSeriesDate(1995, Nov, 14),
//				       createDecimal("2196.11172"),
//				       oneContract, 3);
//  ClosedLongPosition<DecimalType> longPosition18(TimeSeriesDate(1996, May, 22),
//				       createDecimal("3384.33862"),
//				       TimeSeriesDate(1996, May, 28),
//				       createDecimal("3341.01909"),
//				       oneContract, 3);
//  ClosedLongPosition<DecimalType> longPosition19(TimeSeriesDate(1997, Apr, 8),
//				       createDecimal("2683.75391"),
//				       TimeSeriesDate(1997, Apr, 11),
//				       createDecimal("2752.45801"),
//				       oneContract, 3);
//  ClosedLongPosition<DecimalType> longPosition20(TimeSeriesDate(1997, Oct, 17),
//				       createDecimal("2617.33667"),
//				       TimeSeriesDate(1997, Oct, 21),
//				       createDecimal("2684.34049"),
//				       oneContract, 3);
//  ClosedLongPosition<DecimalType> longPosition21(TimeSeriesDate(1999, Sep, 13),
//				       createDecimal("1439.19373"),
//				       TimeSeriesDate(1999, Sep, 15),
//				       createDecimal("1420.77205"),
//				       oneContract, 2);
//  ClosedLongPosition<DecimalType> longPosition22(TimeSeriesDate(2007, Jan, 23),
//				       createDecimal("688.56763"),
//				       TimeSeriesDate(2007, Jan, 24),
//				       createDecimal("679.75396"),
//				       oneContract, 2);
//  ClosedLongPosition<DecimalType> longPosition23(TimeSeriesDate(2008, Jun, 16),
//				       createDecimal("983.35834"),
//				       TimeSeriesDate(2008, Jun, 18),
//				       createDecimal("1008.53231"),
//				       oneContract, 2);
//  ClosedLongPosition<DecimalType> longPosition24(TimeSeriesDate(2008, Jun, 23),
...
//  ClosedShortPosition<DecimalType> shortPosition1(shortEntryDate1, shortEntryPrice1,
...
//  ClosedShortPosition<DecimalType> shortPosition2(shortEntryDate2, shortEntryPrice2,
//				      shortExitDate2, shortExitPrice2,
//				      oneContract, 2);

//  ClosedShortPosition<DecimalType> shortPosition3(TimeSeriesDate(1987, Jan, 30),
//					createDecimal("2690.04077"),
//					TimeSeriesDate(1987, Feb, 5),
//					createDecimal("2653.99423"),
//					oneContract, 4);
//  ClosedShortPosition<DecimalType> shortPosition4(TimeSeriesDate(1987, May, 21),
//					createDecimal("3014.07813"),
//					TimeSeriesDate(1987, May, 26),
//					createDecimal("2973.68948"),
//					oneContract, 2);
//  ClosedShortPosition<DecimalType> shortPosition5(TimeSeriesDate(1987, Jun, 3),
//					createDecimal("3006.15674"),
//					TimeSeriesDate(1987, Jun, 10),
//					createDecimal("2950.70728"),
//					oneContract, 5);
//  ClosedShortPosition<DecimalType> shortPosition6(TimeSeriesDate(1989, Jul, 20),
//					createDecimal("2918.04443"),
//					TimeSeriesDate(1989, Jul, 24),
//					createDecimal("2878.94264"),
//					oneContract, 2);
//  ClosedShortPosition<DecimalType> shortPosition7(TimeSeriesDate(1990, Nov, 19),
//					createDecimal("2703.38110"),
//					TimeSeriesDate(1990, Nov, 20),
//					createDecimal("2667.15580"),
//					oneContract, 1);
//  ClosedShortPosition<DecimalType> shortPosition8(TimeSeriesDate(1991, Jul, 2),
//					createDecimal("2452.33594"),
//					TimeSeriesDate(1991, Jul, 5),
//					createDecimal("2419.47464"),
//					oneContract, 2);
//  ClosedShortPosition<DecimalType> shortPosition9(TimeSeriesDate(1996, May, 2),
//					createDecimal("3180.06665"),
//					TimeSeriesDate(1996, May, 3),
//					createDecimal("3137.45376"),
//					oneContract, 1);
//  ClosedShortPosition<DecimalType> shortPosition10(TimeSeriesDate(1997, Sep, 24),
//					 createDecimal("2444.86743"),
//					 TimeSeriesDate(1997, Sep, 25),
//					 createDecimal("2412.10621"),
//					 oneContract, 1);
//  ClosedShortPosition<DecimalType> shortPosition11(TimeSeriesDate(2001, Mar, 13),
//					 createDecimal("1047.40698"),
//					 TimeSeriesDate(2001, Mar, 14),
//					 createDecimal("1033.37173"),
//					 oneContract, 1);
//  ClosedShortPosition<DecimalType> shortPosition12(TimeSeriesDate(2001, Oct, 24),
//					 createDecimal("853.33160"),
//					 TimeSeriesDate(2001, Oct, 29),
//					 createDecimal("841.89696"),
//					 oneContract, 3);

//  ClosedShortPosition<DecimalType> shortPosition13(TimeSeriesDate(2003, Oct, 3),
//					 createDecimal("735.21429"),
//					 TimeSeriesDate(2003, Oct, 7),
//					 createDecimal("744.62504"),
//					 oneContract, 2);
//  ClosedShortPosition<DecimalType> shortPosition14(TimeSeriesDate(2006, Aug, 10),
//					 createDecimal("450.62540"),
//					 TimeSeriesDate(2006, Aug, 11),
//					 createDecimal("444.58702"),
//					 oneContract, 1);
//  ClosedShortPosition<DecimalType> shortPosition15(TimeSeriesDate(2007, Mar, 29),
//					 createDecimal("644.04504"),
//					 TimeSeriesDate(2007, Mar, 30),
//					 createDecimal("635.41484"),
//					 oneContract, 1);
//  ClosedShortPosition<DecimalType> shortPosition16(TimeSeriesDate(2007, May, 11),
//					 createDecimal("583.31305"),
//					 TimeSeriesDate(2007, May, 14),
//					 createDecimal("575.49665"),
//					 oneContract, 1);
//  ClosedShortPosition<DecimalType> shortPosition17(TimeSeriesDate(2007, May, 25),
//					 createDecimal("592.01331"),
//					 TimeSeriesDate(2007, May, 29),
//					 createDecimal("584.08033"),
//					 oneContract, 1);
//  ClosedShortPosition<DecimalType> shortPosition18(TimeSeriesDate(2008, Jul, 3),
//					 createDecimal("984.19678"),
//					 TimeSeriesDate(2008, Jul, 7),
//					 createDecimal("971.00854"),
//					 oneContract, 1);
//  ClosedShortPosition<DecimalType> shortPosition19(TimeSeriesDate(2008, Dec, 9),
//					 createDecimal("399.64169"),
//					 TimeSeriesDate(2008, Dec, 10),
//					 createDecimal("404.75711"),
//					 oneContract, 1);
//  ClosedShortPosition<DecimalType> shortPosition20(TimeSeriesDate(2010, Nov, 19),
//					 createDecimal("489.98853"),
//					 TimeSeriesDate(2010, Nov, 22),
//					 createDecimal("496.26038"),
//					 oneContract, 1);
//  ClosedShortPosition<DecimalType> shortPosition21(TimeSeriesDate(2011, Sep, 13),
...
//  {
//    ClosedPositionHistory<DecimalType>::ClosedPositionIterator it = closedLongPositions.beginClosedPositions();
...
//  {
//    ClosedPositionHistory<DecimalType>::ConstClosedPositionIterator it = closedLongPositions.beginClosedPositions();
