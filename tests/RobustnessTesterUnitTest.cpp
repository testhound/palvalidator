...
TEST_CASE ("RobustnessTesterUnitTest operations", "[RobustnessTest]")
{
  ...
  SECTION ("RobustnessTester addStrategy test", "[RobustnessTester 1]")
    {
      ...
      palRobust.addStrategy(longStrategy2);
      REQUIRE (palRobust.getNumSurvivingStrategies() == 0);
      REQUIRE (palRobust.getNumStrategiesToTest() == 2);

      palRobust.addStrategy(shortStrategy1);
      REQUIRE (palRobust.getNumSurvivingStrategies() == 0);
      REQUIRE (palRobust.getNumStrategiesToTest() == 3);
    }
  ...
  SECTION ("RobustnessTester addStrategy test", "[RobustnessTester 2]")
    {
      ...
      statisticallyRobust.addStrategy(longStrategy2);
      REQUIRE (statisticallyRobust.getNumSurvivingStrategies() == 0);
      REQUIRE (statisticallyRobust.getNumStrategiesToTest() == 2);

      statisticallyRobust.addStrategy(shortStrategy1);
      REQUIRE (statisticallyRobust.getNumSurvivingStrategies() == 0);
      REQUIRE (statisticallyRobust.getNumStrategiesToTest() == 3);
    }

  SECTION ("PalRobustnessTester runRobustnessTests", "[RobustnessTester 3]")
    {
      std::cout << "Running PalRobustnessTester" << std::endl;
      palRobust.addStrategy(longStrategy1);
      palRobust.addStrategy(longStrategy2);
      palRobust.addStrategy(shortStrategy1);
  ...
  SECTION ("StatRobustnessTester runRobustnessTests", "[RobustnessTester 4]")
    {
      std::cout << "Running StatisticallyRobustTester" << std::endl;
      statisticallyRobust.addStrategy(longStrategy1);
      statisticallyRobust.addStrategy(longStrategy2);
      statisticallyRobust.addStrategy(shortStrategy1);
